function aggregatePerturbationScores = calcAggregateScores(modelMets, cRes, tab, filename)
...
% if filename is present, the results are written in a .csv file in the working directory 
